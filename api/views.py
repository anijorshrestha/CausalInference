...
def owl_detail(request, owl_id):
    ...
    return render(request, 'api/owl.html', {'owl': get_object_or_404(OWLFile, id=owl_id),'uniquekeys':non_causal_list,'causal_relation':possible_causal_list})
...
def owl_live(request, owl_id):
    ...
    return render(request, 'api/live.html', {'owl': get_object_or_404(OWLFile, id=owl_id),"dataProf":data,"df":df.to_dict(),'intervention':''})
